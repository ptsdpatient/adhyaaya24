...
const css$1 = {
  code: ".menu-container.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{width:0px;transition-property:all;transition-duration:500ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}.menu-container.true.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{width:100%}.false.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{width:0px}.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{overflow:clip}.menu.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{width:-moz-fit-content;width:fit-content;--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}.menu-item-container.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{white-space:nowrap;padding-left:10vw;line-height:1rem;opacity:1;transition-property:all;transition-duration:500ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}@media(min-width: 1024px){.menu-item-container.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{padding-left:15vw}}.submenu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{text-transform:uppercase;transition-property:all;transition-duration:500ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{overflow:hidden;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;width:-moz-fit-content;width:fit-content;white-space:nowrap;padding-top:0.75rem;padding-bottom:0.75rem;padding-left:10vw;font-size:2.25rem;line-height:2.5rem;opacity:1;transition-property:all;transition-duration:500ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}@media(min-width: 1024px){.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{padding-left:15vw}}@media(min-width: 1280px){.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{font-size:3rem;line-height:1;line-height:1rem}}@media(min-width: 1536px){.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{font-size:3.75rem;line-height:1}}@media(min-width: 1600px){.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{font-size:4.5rem;line-height:1}}.menu-item.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok:hover{--tw-scale-x:110%;--tw-scale-y:110%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.menu-background-pattern.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{height:100vh;width:100vw;display:none;background-image:radial-gradient(rgba(255, 255, 255, 0.25) 9%, transparent 9%);background-position:var(--bgX, 0%) var(--bgY, 0%);background-size:12vmin 12vmin;position:absolute;top:0;left:0;transition-property:all;transition-duration:1000ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}.menu-background-pattern.mbp-0.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{background-image:radial-gradient(rgba(255, 0, 0, 0.25) 9%, transparent 9%);background-position:var(--bgX, 0%) calc(var(--bgY, 0%) + 0.15%)}.menu-background-pattern.mbp-1.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{background-image:radial-gradient(rgba(0, 255, 0, 0.25) 9%, transparent 9%);background-position:var(--bgX, 0%) calc(var(--bgY, 0%) - 0.15%)}.menu-background-pattern.mbp-2.svelte-1cch5ok.svelte-1cch5ok.svelte-1cch5ok{background-image:radial-gradient(rgba(0, 0, 255, 0.25) 9%, transparent 9%);background-position:calc(var(--bgX, 0%) - 0.15%) var(--bgY, 0%)}.menu-items.svelte-1cch5ok:hover~.menu-background-pattern.svelte-1cch5ok.svelte-1cch5ok{background-size:11vmin 11vmin;opacity:0.5}",
  map: null
};
let bgX = 0, bgY = 0;
...
<div class="${"fixed top-0 w-full min-h-16 z-[200] pointer-events-none flex flex-row px-4 md:px-10 py-4 bg-transparent " + escape("", true) + " items-center print:hidden transition-all duration-700 svelte-1cch5ok"}"><button class="${"logo bg-transparent " + escape(
    $page.url.pathname.includes("success") ? "invisible" : "",
    true
  ) + " w-20 md:w-36 pointer-events-auto py-1 px-2 rounded-lg transition-all duration-250 hover:scale-105 active:scale-95 cursor-pointer mr-auto " + escape("", true) + " svelte-1cch5ok"}"><img${add_attribute("src", adhyaaya_solid_logo, 0)} alt="" class="svelte-1cch5ok"></button>
		
		
		<input id="menu-toggle" type="checkbox" class="hidden svelte-1cch5ok"${add_attribute("checked", isMenuOpen, 1)}>
		<label for="menu-toggle" class="${"menu-icon cursor-pointer h-10 w-10 md:h-12 md:w-12 rounded-full pointer-events-auto relative transition-all duration-500 ease-in-out hover:scale-105 active:scale-95 border " + escape(isMenuOpen ? "border-white" : "border-white/60", true) + " svelte-1cch5ok"}"><div class="absolute w-[18px] h-[2px] origin-center bg-white transition-all ease-in-out duration-500  svelte-1cch5ok" style="${escape(isMenuOpen ? "top: 50%;" : "top: calc(50% - 4px);", true) + " left: 50%; transform: translateX(-50%) translateY(-50%) " + escape(isMenuOpen ? "rotate(-45deg)" : "rotate(0deg)", true) + " translateZ(0px);"}"></div>
			<div class="absolute w-[18px] h-[2px] origin-center bg-white transition-all ease-in-out duration-500 svelte-1cch5ok" style="${escape(isMenuOpen ? "top: 50%;" : "top: calc(50% + 4px);", true) + " left: 50%; transform: translateX(-50%) translateY(-50%) " + escape(isMenuOpen ? "rotate(45deg)" : "rotate(0deg)", true) + " translateZ(0px);"}"></div></label></div>` : ``}
<div class="${"menu-container " + escape(isMenuOpen, true) + " h-full bg-black/30 backdrop-blur-sm rounded-none z-[120] fixed right-0 top-0 flex flex-col print:hidden svelte-1cch5ok"}">${isMenuOpen ? `<div class="${escape(isMenuOpen, true) + " header h-16 md:h-24 lg:h-36 w-full svelte-1cch5ok"}"></div>
		<div class="${escape(isMenuOpen, true) + " menu flex flex-col w-full svelte-1cch5ok"}"><div class="menu-items w-fit flex flex-col justify-evenly h-full z-[150] scale-90 md:scale-100 svelte-1cch5ok"><a href="/" class="menu-item svelte-1cch5ok">Home</a>
				...
				<div class="menu-item-container flex flex-col md:flex-row gap-2 md:gap-14 md:pt-10 svelte-1cch5ok"><a href="/legal/privacy_policy" class="submenu-item text-base  svelte-1cch5ok">Privacy Policy</a>
					<a href="/legal/terms_and_conditions" class="submenu-item text-base svelte-1cch5ok">Terms and Conditions</a>
					<a href="/legal/contact_info" class="submenu-item text-base svelte-1cch5ok">Contact Info</a></div></div>
			<div style="${"--bgX: " + escape(bgX, true) + "%;--bgY: " + escape(bgY, true) + "%"}" class="menu-background-pattern z-[133] svelte-1cch5ok"></div>
			<div style="${"--bgX: " + escape(bgX, true) + "%;--bgY: " + escape(bgY, true) + "%"}" class="menu-background-pattern mbp-0 z-[130] svelte-1cch5ok"></div>
			<div style="${"--bgX: " + escape(bgX, true) + "%;--bgY: " + escape(bgY, true) + "%"}" class="menu-background-pattern mbp-1 z-[131] svelte-1cch5ok"></div>
			<div style="${"--bgX: " + escape(bgX, true) + "%;--bgY: " + escape(bgY, true) + "%"}" class="menu-background-pattern mbp-2 z-[132] svelte-1cch5ok"></div></div>
		<div class="${"" + escape(isMenuOpen, true) + " social w-full flex items-center self-end justify-end py-6 pb-32 md:pb-6 mt-auto z-[140] svelte-1cch5ok"}">${each(SOCIALS, (social) => {
    return `<a rel="noreferrer" target="_blank"${add_attribute("href", social.link, 0)} class="${"h-10 w-10 md:h-12 md:w-12 rounded-full border border-white mx-auto md:ml-0 md:mr-10 inline-flex items-center justify-center text-2xl md:text-3xl cursor-pointer " + escape(social.text, true) + " " + escape(social.bg, true) + " hover:scale-105 active:scale-95 active:opacity-90 transition-all duration-200 ease-in-out svelte-1cch5ok"}"><iconify-icon${add_attribute("icon", social.icon, 0)} class="svelte-1cch5ok"></iconify-icon>
				</a>`;
  })}</div>` : ``}
</div>`;
});
