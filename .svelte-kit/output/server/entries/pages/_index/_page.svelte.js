import { c as create_ssr_component, l as compute_rest_props, o as createEventDispatcher, k as setContext, u as onDestroy, p as spread, q as escape_attribute_value, t as escape_object, f as add_attribute, C as is_void, D as tick, d as getContext, v as validate_component } from "../../../chunks/index2.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Swiper_1, "Swiper").$$render(
            ...
            return `${validate_component(Swiper_1, "Swiper").$$render(
              ...
              {},
              {
                default: () => {
                  return `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
                    default: () => {
                      return `Vertical Slide 1`;
                    }
                  })}
			${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
                    default: () => {
                      return `Vertical Slide 2`;
                    }
                  })}
			${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
                    default: () => {
                      return `Vertical Slide 3`;
                    }
                  })}
			${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
                    default: () => {
                      return `Vertical Slide 4`;
                    }
                  })}
			${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
                    default: () => {
                      return `Vertical Slide 5`;
                    }
                  })}`;
                }
              }
	...
	${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
          default: () => {
            return `Horizontal Slide 3`;
          }
        })}
	${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
          default: () => {
            return `Horizontal Slide 4`;
          }
        })}`;
      }
    }
